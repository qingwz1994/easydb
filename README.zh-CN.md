...
| v1.3.0 | ✅ 已完成 | 深色模式、SQL 文件导入、存储管理、查询收藏、快捷键体系、导出取消优化、自动更新检查、**视图/存储过程/函数/触发器浏览** |
| **v1.3.1** | ✅ 已完成 | **数据库备份恢复**（完整备份、表级选择、一致性快照、SHA-256 校验、恢复策略） |
| **v1.3.2** | 🚧 进行中 | 存储过程执行、参数面板 |
| v1.4.0 | 📋 规划中 | 慢查询分析、国际化 (i18n)、性能监控 |
