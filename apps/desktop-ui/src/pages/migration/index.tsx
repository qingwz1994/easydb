        ...
        <Space size="large">
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <Radio.Group value={mode} onChange={e => setMode(e.target.value)} buttonStyle="solid">
              <Radio.Button value="structure_and_data">结构 + 数据</Radio.Button>
              <Radio.Button value="structure_only">仅结构</Radio.Button>
              <Radio.Button value="data_only">仅数据</Radio.Button>
            </Radio.Group>
          </div>
          <Alert
